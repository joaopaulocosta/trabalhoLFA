...
//Funções de extração de dados do arquivo--------------------------------------------------------------------------------------------------
	...
	public static StringTokenizer  extraiEstados(StringBuilder conteudoArquivo){
	...
	public static StringTokenizer extraiAlfabeto(StringBuilder conteudoArquivo){
	...
	public static StringTokenizer extraiTransicoes(StringBuilder conteudoArquivo){
	...
	public static String extraiEstadoInicial(StringBuilder conteudoArquivo){
	...
	public static ArrayList<String> extraiEstadosFinais(StringBuilder conteudoArquivo){
		int indiceInicial = 0, indiceFinal = 0;
...
//Funções de criação de automato--------------------------------------------------------------------------------------------------
	...
	public static void addEstados(Automato automato, StringTokenizer estados, String estadoInicial, ArrayList<String> estadosFinais){
	 ...
	 *	ao automato 
	 **/
	public static void addTransicoes(Automato automato, StringTokenizer transicoes, StringTokenizer estados){
	...
	public static void addAlfabeto(Automato automato, StringTokenizer alfabeto){
